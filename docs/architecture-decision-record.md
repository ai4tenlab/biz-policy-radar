...
## ADR-002: Apple-style Policy Intelligence 디자인
...
- 적용: warm paper, lacquer ink, kinpaku gold, patina accent를 정책 사이트에 맞게 변형했다. Apple 홈페이지를 복제하지 않고 큰 타이포그래피, 여백, sticky glass nav, 스크롤 reveal, 정제된 editorial hierarchy만 차용했다.
